...
export type Footer = {
  ...
  label: string;
  columns?: Array<{
    type: "fireplaces" | "lighting" | "furniture" | "journal" | "other";
    title: string;
    links?: Array<{
      url?: CustomUrl;
...
// Query: *[_type == "homePage" && _id == "homePage"][0]{    ...,    _id,    _type,    "slug": slug.current,    title,    description,      pageBuilder[]{    ...,    _type,      _type == "hero" => {    ...,    "slides": slides[]{      ...,        "id": asset._ref,  "preview": asset->metadata.lqip,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }    },    links[]{        _key,        "name": url.name,        "openInNewTab": url.openInNewTab,        "href": select(          url.type == "internal" => url.internal->slug.current,          url.type == "external" => url.external,          url.type == "section" => url.section.current,          url.href        ),    }  },      _type == "furnitureType" => {    ...,      richText[]{    ...,    _type == "block" => {      ...,        markDefs[]{    ...,      ...customLink{    openInNewTab,    "href": select(      type == "internal" => internal->slug.current,      type == "external" => external,      type == "section" => section->slug.current,      "#"    ),  }  }    },    _type == "image" => {        "id": asset._ref,  "preview": asset->metadata.lqip,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  },      "caption": caption    }  },      buttons[]{    text,    variant,    _key,    _type,    "openInNewTab": url.openInNewTab,    "href": select(      url.type == "internal" => url.internal->slug.current,      url.type == "external" => url.external,      url.type == "section" => url.section.current,      url.href    ),  },      image {      "id": asset._ref,  "preview": asset->metadata.lqip,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  },  },      _type == "furnitureLists" => {    ...,    lists[]{      ...,        image {      "id": asset._ref,  "preview": asset->metadata.lqip,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }  },    },  },  }  }
...
// Query: *[_type == "footer" && _id == "footer"][0]{    _id,    label,    columns[]{      _key,      title,      type,      links[]{        _key,        "name": url.name,        "openInNewTab": url.openInNewTab,        "href": select(          url.type == "internal" => url.internal->slug.current,          url.type == "external" => url.external,          url.type == "section" => url.section.current,          url.href        ),      }    }  }
export type QueryFooterDataResult = {
  ...
  columns: Array<{
    _key: string;
    title: string;
    type: "fireplaces" | "furniture" | "journal" | "lighting" | "other";
    links: Array<{
      _key: string;
      name: string | null;
      openInNewTab: boolean | null;
...
// Query: *[_type == "navbar" && _id == "navbar"][0]{    _id,    columns[]{      _key,      _type == "navbarColumn" => {        "type": "column",        title,        links[]{          _key,          "name": url.name,          icon,          description,          "openInNewTab": url.openInNewTab,          "href": select(            url.type == "internal" => url.internal->slug.current,            url.type == "external" => url.external,            url.type == "section" => url.section.current,            url.href          )        }      },      _type == "navbarLink" => {        "type": "link",        "name": url.name,        description,        "openInNewTab": url.openInNewTab,        "href": select(          url.type == "internal" => url.internal->slug.current,          url.type == "external" => url.external,          url.type == "section" => url.section.current,          url.href        )      }    },      buttons[]{    text,    variant,    _key,    _type,    "openInNewTab": url.openInNewTab,    "href": select(      url.type == "internal" => url.internal->slug.current,      url.type == "external" => url.external,      url.type == "section" => url.section.current,      url.href    ),  },  }
...
// Query: *[_type == "settings"][0]{    _id,    _type,    siteTitle,    logo {        "id": asset._ref,  "preview": asset->metadata.lqip,  hotspot {    x,    y  },  crop {    bottom,    left,    right,    top  }    },    siteDescription,    contactEmail,    contactPhone,    contactAddress,  }
...
// Query: *[_type == "settings"][0]{    _id,    _type,    siteTitle,    siteDescription,    "logo": logo.asset->url + "?w=80&h=40&dpr=3&fit=max",    contactEmail,    contactPhone,    contactAddress,  }
